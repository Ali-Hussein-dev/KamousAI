    ...
    <CustomMenu width={"270"} position="bottom-start" closeOnItemClick={false}>
      <Menu.Target>
        <Button
          radius="lg"
          pl="0"
          leftSection={<ParaphraserDrawerCustomization />}
...
export const ParaphraserDrawerCustomization = dynamic(
  () =>
    import("@/components/paraphraser/paraphraser-drawer-customization").then(
      (c) => c.ParaphraserBase
    ),
  {
    ssr: false,
